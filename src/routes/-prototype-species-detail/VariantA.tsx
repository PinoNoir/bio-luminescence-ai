// PROTOTYPE — wipe me. Variant A for ticket 10: "Field Specimen Card".
// A two-column data-sheet grid — photo and taxonomy sit side by side like a
// museum specimen card, not stacked. Sightings read as literal logbook entries.
...
function VariantA({ species, sightings }: VariantProps) {
          ...
          <div>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-2">
                {species.funFacts.slice(0, 4).map((fact, i) => (
            ...
            <div className="mt-10 border-t border-white/10 pt-6">
              <h2 className="text-xs uppercase tracking-widest text-white/40 font-data mb-4">
