...
function WormsSearchField({ onSelect, accent = '#00E5FF' }: WormsSearchFieldProps) {
    ...
    <div>
      ...
      {term.length > 2 && (
        <div className="mt-2 border border-white/10 rounded divide-y divide-white/10 max-h-64 overflow-y-auto">
          {isError && <p className="p-3 text-sm text-white/40">WoRMS search failed — check your connection.</p>}
